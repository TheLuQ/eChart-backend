...
func ShortEventQuery() DocQuery {
	return func(cr *firestore.CollectionRef) firestore.Query {
		return cr.SelectPaths(firestore.FieldPath{"title"}, firestore.FieldPath{"date"},
			firestore.FieldPath{"location"}, firestore.FieldPath{"description"}, firestore.FieldPath{"titles"}, firestore.FieldPath{"id"})
	}
}
